      ...
      <div className="max-w-4xl mx-auto">
        <form onSubmit={handleSubmit} className="relative">
          <div className="flex items-end space-x-4 bg-dark-card rounded-2xl p-4 border border-dark-border">
            <button
              type="button"
              className="p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-dark-surface"
            >
            ...
            <div className="flex-1">
              <textarea
                ...
                placeholder="Ask me anything about coding, debugging, or code generation..."
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                input.trim() && !disabled
                  ? 'bg-neon-blue text-black hover:bg-neon-blue-dark'
